# Sistem Pendukung Keputusan Klinis Klasifikasi Status Diabetes
...
## 📦 File Instalasi Program
Untuk menjalankan program ini di komputer lokal, pastikan Python sudah terinstall. Seluruh dependensi pustaka (*library*) yang dibutuhkan terdapat di dalam file `requirements.txt`.

**Langkah Instalasi:**
1. Clone repository ini ke komputer lokal:
   ```bash
   git clone [https://github.com/Iqbalfaridzi23/skripsi-diabetes.git](https://github.com/Iqbalfaridzi23/skripsi-diabetes.git)
